...
function initPositionMap() {
    ...
    var positionLatitude = document.getElementById('position-latitude');
    var positionLongitude = document.getElementById('position-longitude');
    var autocomplete = new google.maps.places.Autocomplete(positionInput);
    ...
    autocomplete.addListener('place_changed', function() {
        ...
        positionLatitude.value = place.geometry.location.lat();
        positionLongitude.value = place.geometry.location.lng();
