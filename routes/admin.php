...
Route::group(['as' => 'service.'], function () {
    Route::resource('service/{service}/question', 'Resource\ServiceQuestionResource');
//    Route::get('service/{service}/question/{question}/enable', 'Resource\ServiceQuestionResource@enable')->name('question.enable');
//    Route::get('service/{service}/question/{question}/disable', 'Resource\ServiceQuestionResource@disable')->name('question.disable');
    Route::group(['as' => 'question.'], function () {
        Route::resource('service/{service}/question/{question}/answer', 'Resource\ServiceAnswerResource');
//        Route::get('service/{service}/question/{question}/answer/{answer}/enable', 'Resource\ServiceAnswerResource@enable')->name('answer.enable');
//        Route::get('service/{service}/question/{question}/answer/{answer}/disable', 'Resource\ServiceAnswerResource@disable')->name('answer.disable');
    });
});
