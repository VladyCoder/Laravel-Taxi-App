...
Route::post('twilio/sms', 'Auth\SocialLoginController@twilio_sms')->name('twilio.sms');
Route::post('twilio/email', 'Auth\SocialLoginController@twilio_email')->name('twilio.email');
Route::post('twilio/code', 'Auth\SocialLoginController@twilio_code')->name('twilio.code');
