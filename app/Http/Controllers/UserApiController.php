...
class UserApiController extends Controller
{
    ...
    public function details(Request $request){
        ...
        try{
            if($user = User::find(Auth::user()->id)){
                ...
                $user->epay_api_key = Setting::get('epay_public_key', '');
                $user->epay_private_key = Setting::get('epay_private_key', '');
                return $user;
    ...
    public function services() {
        if($serviceList = ServiceType::with('questions.answers')->get()) {
            return $serviceList;
        } else {
    ...
    public function send_request(Request $request) {
        ...
        try{
            ...
            if($request->has('question')) {
                $UserRequest->question = serialize($request->question);
            }
    ...
    public function send_admin_request(Request $request) {
        ...
        try {
            ...
            if($request->has('question')) {
                $UserRequest->question = $request->question;
            }
