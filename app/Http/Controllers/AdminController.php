...
class AdminController extends Controller
{
    ...
    public function settings_payment_store(Request $request)
    {
        ...
        $this->validate($request, [
                ...
                'epay_public_key' => 'required_if:EPAY,on|max:255',
                'epay_private_key' => 'required_if:EPAY,on|max:255',                
        ...
        Setting::set('EPAY', $request->has('EPAY') ? 1 : 0 );
        ...
        Setting::set('epay_public_key', $request->epay_public_key);
        Setting::set('epay_private_key', $request->epay_private_key);
