    ...
    <div class="row">
        <div class="col-md-4 offset-md-4 px-3">
            <div class="box b-a-0">
                ...
                <form class="form-material mb-1" role="form" method="POST" action="{{ url('/fleet/login') }}" >
                {{ csrf_field() }}
                    ...
                    <div class="px-2 form-group mb-0">
                        <input type="checkbox" name="remember"> Crea una nueva cuenta
                    </div>
                    <br>
                    <div class="px-2 form-group mb-0">
                        <button type="submit" class="btn btn-purple btn-block text-uppercase">Iniciar sesión</button>
                    </div>
                </form>
