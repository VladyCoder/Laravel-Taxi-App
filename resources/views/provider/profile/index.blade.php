                        ...
                        <form class="profile-form" action="{{route('provider.profile.update')}}" method="POST" enctype="multipart/form-data" role="form">
                                ...
                                <div class="row no-margin">
                                    <div class="prof-sub-col col-sm-6 col-xs-12 no-left-padding">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="@lang('provider.profile.first_name')" name="first_name" value="{{ Auth::guard('provider')->user()->first_name }}" data-validation="alphanumeric" data-validation-allowing=" -" data-validation-error-msg="@lang('provider.profile.first_name') can only contain alphanumeric characters and . - spaces">
                                        </div>
                                    </div>
                                    <div class="prof-sub-col col-sm-6 col-xs-12 no-right-padding">
                                        <div class="form-group">
                                            <label>@lang('provider.profile.last_name')</label>
                                            <input type="text" class="form-control" placeholder="@lang('provider.profile.last_name')" name="last_name" value="{{ Auth::guard('provider')->user()->last_name }}" data-validation="alphanumeric" data-validation-allowing=" -" data-validation-error-msg="@lang('provider.profile.last_name') can only contain alphanumeric characters and . - spaces">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row no-margin">
                                    <div class="prof-sub-col col-sm-6 col-xs-12 no-left-padding">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" required placeholder="Contact Number" name="mobile" value="{{ Auth::guard('provider')->user()->mobile }}" data-validation="custom length" data-validation-length="10-16" data-validation-regexp="^([0-9\+ ]+)$"data-validation-error-msg="Incorrect phone number">
                                        </div>
                                    </div>
                                    <div class="prof-sub-col col-sm-6 col-xs-12 no-right-padding">
                            ...
                            <div class="prof-form-sub-sec border-top">
                                @if(Auth::guard('provider')->user()->service)
                                    @foreach(Auth::guard('provider')->user()->service as $service)
                                        <div class="row no-margin">
                                            <div class="prof-sub-col col-sm-6 col-xs-12 no-left-padding">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="service_type[]" data-validation="required">
                                                        ...
                                                        @foreach(get_all_service_types() as $type)
                                                            <option @if($service->service_type->id == $type->id) selected="selected" @endif value="{{$type->id}}">{{$type->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="prof-sub-col col-sm-6 col-xs-12 no-right-padding">
                                                <div class="form-group no-margin">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="@lang('provider.profile.car_number')" name="service_number[]" value="{{ $service->service_number ? $service->service_number : "" }}" data-validation="alphanumeric" data-validation-allowing=" -" data-validation-error-msg="@lang('provider.profile.car_number') can only contain alphanumeric characters and - spaces">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row no-margin">
                                            <div class="prof-sub-col col-sm-6 col-xs-12 no-left-padding">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"  placeholder="@lang('provider.profile.car_model')" class="form-control" name="service_model[]" value="{{ $service->service_model ? $service->service_model : "" }}" data-validation="alphanumeric" data-validation-allowing=" -" data-validation-error-msg="@lang('provider.profile.car_model') can only contain alphanumeric characters and - spaces">
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
