...
@section('content')
<div class="col-md-12">
    <a class="log-blk-btn" href="{{ url('/provider/register') }}">¿Ya tienes una cuenta?</a>    
...
<div class="col-md-12">
    ...
    <p class="helper">Or <a href="{{url('provider/login')}}">Inicie sesión</a> con su cuenta de usuario.</p>   
