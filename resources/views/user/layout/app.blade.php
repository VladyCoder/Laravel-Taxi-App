    ...
    <div id="wrapper">
        ...
        <!-- <nav class="navbar navbar-inverse navbar-fixed-top" id="sidebar-wrapper" role="navigation">
            <ul class="nav sidebar-nav">
                ...
                <li class="full-white">
                    <a href="{{ url('/register') }}">Entrar como usuario</a>
                </li>
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav">
                                <li @if(Request::url() == url('/ride')) class="active" @endif>
                                    <a href="{{url('/ride')}}">Usuarios</a>
                                </li>
                                <li @if(Request::url() == url('/drive')) class="active" @endif>
                                    <a href="{{url('/drive')}}">Conductores</a>
                                </li>
                                 <li><a href="{{ url('help') }}">Contáctanos</a></li>
                                  
                            </ul>
                            <ul class="nav navbar-nav navbar-right">
                               
                                <li><a class="btn-outline" href="{{url('/register')}}">Entrar como usuario</a></li>
                                <li><a class="menu-btn" href="{{url('/provider/register')}}">Entrar como Conductor</a></li>
                            </ul>
                        </div>
                    </div>
                </nav>
...
')  }}</a> </h3>
    ...
    <div class="container pad-60"">
        <div class="row center">
            <h2>¡Descárgala ya!</h2>
            <p class="white">(Obtenga las aplicaciones de Android y iOS para usuarios y conductores de forma gratuita)</p><br>
            <div class="">
            ...
            <div class="col-md-6 col-md-offset-3">
                 <div class="socil-media">
                   <ul>
                                    ...
                                    <li><a target="_blank" href="{{Setting::get('store_instagram_link','#')}}"><i class="fa fa-3x fa-instagram"></i></a></li>
                                </ul>
                 </div>
             </div>
    </div>
                        ...
                        <div class="row no-margin">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                <ul>
                                    <li><a href="{{url('ride')}}">Entrar como usuario</a></li>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>{{ Setting::get('site_title','Tranxit') }} is available in your city</p>
      </div>
