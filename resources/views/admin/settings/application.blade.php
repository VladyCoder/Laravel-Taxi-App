    ...
    <div class="container-fluid">
    	<div class="box box-block bg-white">
            ...
            <form class="form-horizontal" action="{{ route('admin.settings.store') }}" method="POST" enctype="multipart/form-data" role="form">
				...
				<div class="form-group row">
					<label for="default_lang" class="col-xs-2 col-form-label">@lang('admin.setting.Default_Language')</label>
					<div class="col-xs-10">
						<select class="form-control" id="default_lang" name="default_lang">
							<option value="en" @if(Setting::get('default_lang') == 'en') selected @endif>@lang('admin.language.English')</option>
							<option value="ar" @if(Setting::get('default_lang') == 'ar') selected @endif>@lang('admin.language.Arabic')</option>
							<option value="es" @if(Setting::get('default_lang') == 'es') selected @endif>@lang('admin.language.Spanish')</option>
						</select>
					</div>
				</div>
				...
				<div class="form-group row">
					<label for="store_link_ios" class="col-xs-2 col-form-label">@lang('admin.setting.Instagram_Link')</label>
					<div class="col-xs-10">
						<input class="form-control" type="text" value="{{ Setting::get('store_instagram_link', '')  }}" name="store_instagram_link"  id="store_instagram_link" placeholder="@lang('admin.setting.Instagram_Link')">
					</div>
				</div>
