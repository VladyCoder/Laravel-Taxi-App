            ...
            <div class="box box-block bg-white">
                <div class="form-group row">
                    <div class="col-md-4 col-xs-12">
                        ...
                        <table class="table table-striped table-bordered dataTable common-table">
                            <thead>
                                <tr>
                                    <th>@lang('admin.id')</th>
                            ...
                            <tbody>
                                @foreach($OnlineProviders as $index => $provider)
                                    <tr>
                                        <td>{{$index + 1}}</td>
                    ...
                    <div class="col-md-4 col-xs-12">
                        ...
                        <table class="table table-striped table-bordered dataTable common-table">
                            ...
                            <tbody>
                            @foreach($BusyProviders as $index => $provider)
                                <tr>
                                    <td>{{$index + 1}}</td>
                                    <td>{{$provider->first_name}}</td>
                                    <td>{{$provider->email}}</td>
                    ...
                    <div class="col-md-4 col-xs-12">
                        ...
                        <table class="table table-striped table-bordered dataTable common-table">
                            ...
                            <tbody>
                            @foreach($OfflineProviders as $index => $provider)
                                <tr>
                                    <td>{{$index + 1}}</td>
                                    <td>{{$provider->first_name}}</td>
                                    <td>{{$provider->email}}</td>
