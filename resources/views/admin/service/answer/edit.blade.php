...
@section('title', 'Update Service Answer ')
    ...
    <div class="content-area py-1">
        <div class="container-fluid">
            <div class="box box-block bg-white">
                ...
                <h5 style="margin-bottom: 2em;">@lang('admin.service.Update_Service_Answer')</h5>
                ...
                <form class="form-horizontal" action="{{route('admin.service.question.answer.update', [$ServiceType->id, $ServiceQuestion->id, $ServiceAnswer->id] )}}" method="POST" enctype="multipart/form-data" role="form">
                    {{csrf_field()}}
                    <input type="hidden" name="_method" value="PATCH">
                    <div class="form-group row">
                        <label for="name" class="col-xs-2 col-form-label">@lang('admin.service.Answer')</label>
                        <div class="col-xs-5">
                            <input class="form-control" type="text" value="{{ $ServiceAnswer->answer }}" name="answer" required id="answer" placeholder="Service Answer">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-5">
                            <select class="form-control" id="calculator" name="calculator">
                                <option value="MIN" @if($ServiceAnswer->calculator =='MIN') selected @endif>@lang('servicetypes.MIN')</option>
                                <option value="HOUR" @if($ServiceAnswer->calculator =='HOUR') selected @endif>@lang('servicetypes.HOUR')</option>
                                <option value="DISTANCE" @if($ServiceAnswer->calculator =='DISTANCE') selected @endif>@lang('servicetypes.DISTANCE')</option>
                                <option value="DISTANCEMIN" @if($ServiceAnswer->calculator =='DISTANCEMIN') selected @endif>@lang('servicetypes.DISTANCEMIN')</option>
                                <option value="DISTANCEHOUR" @if($ServiceAnswer->calculator =='DISTANCEHOUR') selected @endif>@lang('servicetypes.DISTANCEHOUR')</option>
                            </select>
                        </div>
                        <div class="col-xs-5">
                    ...
                    <div class="form-group row" >
                        ...
                        <div class="col-xs-5">
                            <input class="form-control" type="text" value="{{ $ServiceAnswer->hour }}" name="hour" id="hourly_price" placeholder="Set Hour Price (Only for DISTANCEHOUR)">
                        </div>
                        <div class="col-xs-5">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-5">
                            <input class="form-control" type="text" value="{{ $ServiceAnswer->fixed }}" name="fixed" required id="fixed" placeholder="Base Price">
                        </div>
                        <div class="col-xs-5">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-5">
                            <input class="form-control" type="text" value="{{ $ServiceAnswer->distance }}" name="distance" id="distance" placeholder="Base Distance">
                        </div>
                        <div class="col-xs-5">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-5">
                            <input class="form-control" type="text" value="{{ $ServiceAnswer->minute }}" name="minute" id="minute" placeholder="Unit Time Pricing">
                        </div>
                        <div class="col-xs-5">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-5">
                            <input class="form-control" type="text" value="{{ $ServiceAnswer->price }}" name="price" id="price" placeholder="Unit Distance Price">
                        </div>
                        <div class="col-xs-5">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-5">
                            <textarea class="form-control" name="description" id="description" placeholder="Description" rows="4">{{ $ServiceAnswer->description }}</textarea>
                        </div>
                    </div>
                    ...
                    {{--<div class="form-group row">--}}
                        ...
                        {{--<div class="col-xs-5">--}}
                            {{--<select class="form-control" id="status" name="status">--}}
                                {{--<option value="1" @if($ServiceAnswer->status) selected @endif>@lang('admin.enable')</option>--}}
                                {{--<option value="0" @if(!$ServiceAnswer->status) selected @endif>@lang('admin.disable')</option>--}}
                            {{--</select>--}}
                        {{--</div>--}}
                    {{--</div>--}}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-12 col-sm-6 offset-md-6 col-md-3">
                            <button type="submit" class="btn btn-primary btn-block">@lang('admin.service.Update_Service_Answer')</button>
                        </div>
                    </div>
                </form>
            </div>
...
@section('scripts')
    <script type="text/javascript">
        var cal='DISTANCE';
        priceInputs('{{$ServiceAnswer->calculator}}');
