            ...
            <div class="col-lg-8 col-lg-offset-2 col-md-6 col-md-offset-3 col-md-8 col-md-offset-2">
                ...
                <div id="userform">
                    <ul class="nav nav-tabs nav-justified" role="tablist">
                        ...
                        <li @if ($errors->has('login_type') && $errors->first('login_type') == 'dispatcher')  class="active" @endif><a href="#dispatcher" role="tab" data-toggle="tab">@lang('admin.dispatcher.dispatcher')</a></li>
                        <li @if ($errors->has('login_type') && $errors->first('login_type') == 'fleet')  class="active" @endif><a href="#fleet" role="tab" data-toggle="tab">@lang('admin.fleet.fleet')</a></li>
                         <li @if ($errors->has('login_type') && $errors->first('login_type') == 'account')  class="active" @endif><a href="#account" role="tab" data-toggle="tab">@lang('admin.include.account')</a></li>
                    </ul>
                        ...
                        <div class="tab-pane fade @if (!$errors->has('login_type')) active @endif in" id="signup">
                            ...
                            <form id="signup" role="form" method="POST" action="{{ url('/admin/login') }}">
                                ...
                                <div class="mrgn-30-top">
                                    <button type="submit" class="btn btn-larger btn-block" /> @lang('auth.login')</button>
                                </div>
                            </form>
                            <div class="row">
                                <div class="col-xs-12 col-sm-12">
